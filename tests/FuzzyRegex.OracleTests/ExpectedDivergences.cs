    ...
    [
        ...
        new(
            ...
            Reason: "THIS PORT PERMITS A FUZZY INSERTION AT THE SEARCH ANCHOR where a position "
                ...
                + "with that edit in place and the wave is GREEN with five of its seven rows "
                + "classified here, where the shipped code classifies four - the fifth is "
                + "`\\b(?:abc){i<=2}` over 'x abc', a one-step-on row the shipped rule answers the "
                + "same as upstream and the broken one does not. Disabling the entry turns the "
                + "difference into a plain count: four of the seven rows diverge on the shipped "
                + "code and five on the broken one, measured 2026-09-21. No predicate that answers by running "
                ...
                + "`test_fuzzy` named-list rows. That edit turns four of the ported suite's 6,504 "

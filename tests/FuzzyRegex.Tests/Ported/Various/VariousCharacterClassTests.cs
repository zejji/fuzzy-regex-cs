...
/// <remarks>
/// <para>
/// The 77 rows of the table whose patterns hold a character class: 60 that match and 17 that do not.
/// S17 delivered the classes themselves, so the rows are split again here by what each still waits
/// on - 27 + 15 (a group) + 18 (a quantifier) among the matching rows, 15 + 1 + 1 among the rest.
/// </para>
/// <para>
...
public sealed class VariousCharacterClassTests
{
    ...
    [Property(
        "Upstream",
        "RegexTests.test_various#25-26,28-29,38,82,84-88,95-97,99,102,146,252,254-257,262-263,265,268,306"
    )]
    ...
    // Split out at S17: the class in each of these matches now, but reading the result needs a
    // capture group. Several also hold a quantifier, so S19 will have to re-triage whatever S18
    // leaves failing.
    [Test]
    ...
    // Split out at S17: the class matches, the repeat around it does not exist yet.
    [Test]

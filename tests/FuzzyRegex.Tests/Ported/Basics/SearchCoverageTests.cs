...
public sealed class SearchCoverageTests
{
    ...
    [Skip("needs:character-classes - \\s is a set, and reading group 1 then needs groups (S18)")]
    ...
    [Skip("needs:character-classes - \\s compiles to a set, which the matcher has no case for yet")]

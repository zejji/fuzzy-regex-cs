...
{
    [Test]
    [Skip("needs:line-boundaries - the engine has no . opcode yet")]
    ...
    [Test]
    [Skip("needs:word-flag - the WORD flag is not implemented and is not on FuzzyRegexOptions")]
    ...
    [Arguments("\nabc", 1)]
    [Arguments("\rabc", null)]
    [Skip("needs:line-boundaries - the engine has no multiline ^ opcode yet")]

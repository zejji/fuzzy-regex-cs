...
public sealed class PortedTestConventionsTests
{
    ...
    public void Every_ported_test_in_this_assembly_conforms()
    {
        ...
        var portedTests =
            ...
            where type.Namespace?.StartsWith(PortedTestConventions.PortedNamespaceRoot, StringComparison.Ordinal) == true
            ...
            select (
                ...
                SkipReason: System.Reflection.CustomAttributeExtensions.GetCustomAttribute<SkipAttribute>(method)?.Reason
